...
public class ItemController {
    ...
    public Result ItemController(@RequestBody Item item) {
        ...
        if(changeNumbers==null){
            return Result.buildApiResult(400,"选择题数据库获取失败",null);
        }
